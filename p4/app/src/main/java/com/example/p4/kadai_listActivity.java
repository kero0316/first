...
public class kadai_listActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // データベースから値を取得する
        if(helper == null){
            helper = new CustomOpenHelper(kadai_listActivity.this);
        }
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 保存後に一覧へ戻る
                Intent intent = new Intent(kadai_listActivity.this, kadaiActivity.class);
