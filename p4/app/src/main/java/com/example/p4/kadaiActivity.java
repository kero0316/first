...
public class kadaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kadai);

        // データベースから値を取得する
        if(helper == null){
            helper = new CustomOpenHelper(kadaiActivity.this);
        }
        // メモリストデータを格納する変数
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(kadaiActivity.this, com.example.p4.kadai_listActivity.class);
...
//                TextView idTextView = (TextView)two.findViewById(android.R.id.text2);
        ...
        newButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // kadai_listActivityへ遷移
                Intent intent = new Intent(kadaiActivity.this, kadai_listActivity.class);
                intent.putExtra("id", "");
                startActivity(intent);
            }
        });
